...
issues](https://github.com/MoneyByte/copay/issues) in order to learn if the issue is already reported. It could be fixed already. 

Please also check our [FAQ](https://github.com/MoneyByte/copay/wiki/COPAY---FAQ).
...
To open an issue go to [Github Issues](https://github.com/MoneyByte/copay/issues).
